...
# FIXME: Changed the classic Jupyterhub KubeSpawner to my own CustomKubeSpawner for testing
# c.JupyterHub.spawner_class = "kubespawner.KubeSpawner"
c.JupyterHub.spawner_class = "kubespawner.CustomKubeSpawner"
...
config_dir = "/mnt/temp/jupyterhub_config.d"
...
# FIXME: Added custom configuration (my own spawn form and a pre-spawn hook)
from kubespawner import KubeSpawner
from tornado import web

# Define the HTML form template
form_template = """
    <h3>Choose required resources</h3>
    <p><i>Note:</i> The notebook is spawned only when <b>all</b> the required resources are available on a single node.</p>

    <h4>Select CPU limit</h4>
    <select class="data-list-input" id="cpuselection" name="cpuselection" required="required" style="width:190px;">
    ...
    <h4>Select memory limit (in GB)</h4>
